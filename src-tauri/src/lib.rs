...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::planner::get_latest_task_plan,
            commands::planner::start_task_plan,
            commands::planner::confirm_task_plan,
            commands::merge::get_merge_manager,
            commands::merge::reset_merge_manager,
            commands::merge::set_task_ready_to_merge,
            commands::merge::update_merge_settings,
            commands::merge::start_merge_run,
            commands::merge::resolve_merge_run,
            commands::merge::retry_merge_run,
            commands::test_manager::get_test_manager,
            commands::test_manager::reset_test_manager,
            commands::test_manager::update_test_settings,
            commands::test_manager::start_test_run,
            commands::test_manager::resolve_test_run,
            commands::test_manager::retry_test_run,
